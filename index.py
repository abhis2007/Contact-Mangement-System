...
#============================LABELS======================================
lbl_title = Label(Top, text="CONTACT MANAGEMENT SYSTEM Made By:-Abhishek And Their Team", font=('arial', 16), width=500)
#lbl_title = Label(Top, text="Made By Abhishek And Their Team", font=('arial', 16), width=200)
lbl_title.pack(fill=X)
